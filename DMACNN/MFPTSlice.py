...
def get_files(root, test=False):
    ...
    '''
    m = os.listdir(root)
    datasetname = os.listdir(os.path.join("/tmp", root, m[1]))  # '1 - Three Baseline Conditions'
    ...
    dataset1 = os.listdir(os.path.join(root, m[1], datasetname[5]))  # 'Three Baseline Conditions'
    dataset2 = os.listdir(os.path.join(root, m[1], datasetname[3]))  # 'Seven More Outer Race Fault Conditions'
    dataset3 = os.listdir(os.path.join(root, m[1], datasetname[4]))  # 'Seven Inner Race Fault Conditions'
    data_root1 = os.path.join(root, m[1], datasetname[5])  # Path of Three Baseline Conditions
    data_root2 = os.path.join(root, m[1], datasetname[3])  # Path of Seven More Outer Race Fault Conditions
    data_root3 = os.path.join(root, m[1], datasetname[4])  # Path of Seven Inner Race Fault Conditions
...
# datasets = {}
# datasets['train'], datasets['val'] = MFPTSlice(path, "mean-std").data_preprare()
...
#     print(batch_idx)
#     plt.imshow(inputs[0].reshape(24, 24))
#     print(labels[0])
#     break
# plt.show()